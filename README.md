...
For models not using extra training data, HIH has got: <br> -<strong>Rank 1</strong> on [WFLW Leaderboard](https://paperswithcode.com/sota/face-alignment-on-wflw) <br> -**Rank 1** on [COFW Leaderboard](https://paperswithcode.com/sota/face-alignment-on-cofw) <br> -**Rank 3** on [300W Leaderboard](https://paperswithcode.com/sota/face-alignment-on-300w).
